...
gcloud container clusters create bts-cluster3 --zone europe-north1-a --num-nodes 2 --machine-type=e2-medium
docker build -f Dockerfile.server-retrain -t bts-server-retrain:latest .
